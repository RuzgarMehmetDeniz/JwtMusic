...
namespace JwtMusic.WebUI.Validators.ArtistValidatorDtos
{
    public class ArtistUpdateValidator : AbstractValidator<UpdateArtistDto>
    {
        public ArtistUpdateValidator()
        {
            RuleFor(x => x.ArtistId)
                .GreaterThan(0).WithMessage("Geçersiz sanatçı kaydı.");
